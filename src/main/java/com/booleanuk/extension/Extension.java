...
public class Extension extends ExtensionBase {
     ...
     */
    public int calculateGramsOfSugar(String[] ingredients, int nLayers) {
        boolean sugarIsIngredient = false;
        for (String ingredient : ingredients) {
            sugarIsIngredient |= ingredient.equals("sugar");
        }
        return sugarIsIngredient ? nLayers * 100 : 0;
    }
